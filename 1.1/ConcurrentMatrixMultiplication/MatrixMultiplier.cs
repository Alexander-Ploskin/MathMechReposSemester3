...
namespace ConcurrentMatrixMultiplication
{
    ...
    public static class MatrixMultiplier
    {
        ...
        public static Matrix MultiplySequentally(Matrix firstMatrix, Matrix secondMatrix)
        {
            ...
            {
                throw new ArgumentException("Amount of columns in the first matrix must to be equal to amount of rows in the second matrix");
            }
        ...
        /// <param name="secondMatrix">second matrix</param>
        /// <returns>New matrix</returns>
        public static Matrix MultiplyConcurrentally(Matrix firstMatrix, Matrix secondMatrix)
        {
            if (firstMatrix.Width != secondMatrix.Height)
            {
                throw new ArgumentException("Amount of columns in the first matrix must to be equal to amount of rows in the second matrix");
            ...
            for (int i = 0; i < amountOfThreads; ++i)
            {
                ...
                threads[i] = new Thread(() => MultiplyChank(firstMatrix, secondMatrix, startIndex, lastIndex, result));
        ...
        private static void MultiplyChank(Matrix firstMatrix, Matrix secondMatrix, int firstRow, int lastRow, int[,] buffer)
        {
