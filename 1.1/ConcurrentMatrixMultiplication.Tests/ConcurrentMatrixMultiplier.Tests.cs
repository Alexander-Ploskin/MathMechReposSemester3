...
namespace ConcurrentMatrixMultiplication.Tests
{
    ...
    class ConcurrentMatrixMultiplierTests
    {
        ...
        {
            var matrix = ConcurrentMatrixMultiplier.Multiply(matrix1, matrix2);
        ...
        public void IncorrectSizedMatricesTest()
        {
            ...
            matrix2 = new List<List<int>>() {
                new List<int> { 1, 2, 3 },
                new List<int> { 4, 5, 6 } };
            Assert.Throws<ArgumentException>(() => ConcurrentMatrixMultiplier.Multiply(matrix1, matrix2));
        }
        ...
        public void BigMatricesMultiplicationTest()
        {
            ...
            Assert.IsTrue(MatrixComparer.Compare(ConcurrentMatrixMultiplier.Multiply(matrix1, matrix2), matrix3));
        }
