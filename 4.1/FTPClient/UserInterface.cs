...
namespace FTPClient
{
    ...
    class UserInterface
    {
                    ...
                    case "1":
                        {
                            ...
                            {
                                Console.WriteLine("Invaild server response");
                            }
                            break;
                        }
                    case "2":
                        {
                            var response = await fTPClient.GetAsync(path);
        ...
        private void ShowListResult((int size, IEnumerable<(string, bool)> items) response)
        {
